...
void Menu::subMenuABML_Clientes()
{
    ...
    do
    {
        ...
        case 2:
        {
            ...
            {
                cout << "Cliente (ID " << id_persona << ") dado de baja logicamente (Estado: INACTIVO)." << endl ;
            }
            else
            {
        ...
        case 3:
        {
            ...
            if (reg.altaLogica(id_persona))
            {
                ...
                cout << "Cliente (ID " << id_persona << ") dado de alta (Estado: ACTIVO)." << endl ;
...
void Menu::subMenuABML_Proveedores()
{
    ...
    do
    {
        ...
        case 2:
        {
            ...
            {
                cout << "Proveedor (ID " << id_proveedor << ") dado de baja logica (Estado: INACTIVO)." << endl ;
            }
            else
            {
                cout << "ERROR: No se pudo completar la baja." << endl ;
        ...
        case 3:
        {
            ...
            {
                cout << "Proveedor (ID " << id_proveedor << ") dado de alta (Estado: ACTIVO)." << endl ;
            }
            else
            {
                cout << "ERROR: No se pudo completar la baja." << endl ;
    ...
    do
    {
        ...
        case 5:
        {
            ...
            if (archivo1.altaLogica(idAlta))
            {
                ...
                cout << "Producto (ID " << idAlta << ") dado de alta (Estado: ACTIVO)." << endl ;
    ...
    do
    {
        ...
        case 3:   // Anular Envio
        {
            ...
            else
            {
                ...
                cout << "ERROR: No se pudo anular el envio." << endl ;

                cout << "Posibles razones: El ID " << idBaja << " no existe, o el envio ya esta inactivo." << endl ;
            }
