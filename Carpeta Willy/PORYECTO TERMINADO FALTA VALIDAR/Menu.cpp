...
void Menu::subMenuABML_Clientes()
{
    ...
    do
    {
        ...
        case 2:
        {
            ...
            {
                cout << "Error: el id no corresponde a ningun cliente" << endl ;
            }
    ...
    do
    {
        ...
        case 5:
        {
            ...
            if (cantidad == 0)
            {
                ...
                cout << "No hay Detalles de Ventas cargados en el sistema." << endl ;
        ...
        case 7:
        {
            ...
            if (cantidad == 0)
            {
                cout << "No hay envios cargados." << endl ;
                break ;
            }
...
void Menu::subMenuABML_Listados_Activos()
{
    ...
    do
    {
        ...
        cout << "5. Listado de Detalle de Ventas Activas" << endl ;
        ...
        case 5:
        {
            ...
            if (cantidad == 0)
            {
                ...
                cout << "No hay Detalle de ventas cargadas en el sistema." << endl ;

                break ;
            }

            cout << "Listado de todas los Detalles de las ventas Acivas" << endl ;
...
void Menu::subMenuReportes()
{
    ...
    do
    {
        ...
        cout << "1. Recaudacion por anio y mes" << endl ;

        cout << "2. Recaudacion por cliente" << endl ;

        cout << "3. Recaudacion historica por producto" << endl ;

        cout << "4. Recaudacion por tipo de producto" << endl ;
        ...
        case 1:  { // Recaudación Anual
            ...
            int anio ;
                ...
                float recaudacionTotal ; // Variable para capturar el valor devuelto
                ...
                recaudacionTotal = archivoVenta.calcularRecaudacion(anio) ;
        ...
        case 3:   {  // Recaudación Mensual

            cout << "3. Recaudacion Historica por Producto" << endl ;

            system("cls") ;

            cout << "REPORTE DE RECAUDACION HISTORICA POR PRODUCTO" << endl ;

            archivoDetalle.generarReporteRecaudacionPorProducto() ;
        ...
        case 4: {
            ...
            cout << "REPORTE DE RECAUDACION HISTORICA POR TIPO DE PRODUCTO" << endl ;

            archivoDetalle.generarReporteRecaudacionPorTipoProducto() ;
...
do
{
    system("cls") ;
        ...
        cout << "1. Realizar Copia de seguridad de todos los archivos" << endl ;

        cout << "2. Realizar Copia de seguridad de ventas" << endl ;

        cout << "3. Realizar Copia de seguridad de productos " << endl ;

        cout << "4. Realizar Copia de seguridad de envios" << endl ;

        cout << "5. Realizar Copia de seguridad de proveedores" << endl ;

        cout << "6. Realizar Copia de seguridad de clientes" << endl ;

        cout << "7. Realizar Copia de seguridad de empleados" << endl ;

        cout << "8. Realizar Copia de seguridad de los detalles de ventas" << endl ;

        cout << "9. Restaurar Copia de seguridad de ventas" << endl ;

        cout << "10. Restaurar Copia de seguridad de productos " << endl ;

        cout << "11. Restaurar Copia de seguridad de envios " << endl ;

        cout << "12. Restaurar Copia de seguridad de proveedores" << endl ;

        cout << "13. Restaurar Copia de seguridad de clientes" << endl ;

        cout << "14. Restaurar Copia de seguridad de empleados" << endl ;

        cout << "15. Restaurar Copia de seguridad de los detalles de ventas" << endl ;

        cout << "16. Restaurar Copia de seguridad de todos los archivos" << endl ;
        ...
        case 1 : {
            ...
            VentaArchivo regV ;
                ...
                bool exitoV = regV.hacerBackup() ;

                if(exitoV== true){

                    cout << "BACKUP DE VENTAS REALIZADO CON EXITO." << endl ;

                }else{

                    cout << "ERROR: NO SE PUDO REALIZAR EL BACKUP DE VENTAS." << endl ;
        ...
        // PRODUCTOS
                ...
                ProductoArchivo regP  ;

                bool exitoP = regP.hacerBackup() ;

                 if(exitoP == true){

                    cout << "BACKUP DE PRODUCTOS REALIZADO CON EXITO." << endl ;

                } else {

                    cout << "ERROR: NO SE PUDO REALIZAR EL BACKUP DE PRODUCTOS." << endl ;
            ...
            bool exitoE = regE.hacerBackup() ;

            if (exitoE == true) {

                cout << "BACKUP DE ENVIOS REALIZADO CON EXITO." << endl ;

            } else {

                    cout << "ERROR: NO SE PUDO REALIZAR EL BACKUP DE ENVIOS." << endl ;

                    system("pause") ;
                }


          ProveedorArchivo regPr ;

            bool exitoPr = regPr.hacerBackup() ;

            if (exitoPr == true) {

                cout << "BACKUP DE PROVEEDORES REALIZADO CON EXITO." << endl ;



            } else {

                    cout << "ERROR: NO SE PUDO REALIZAR EL BACKUP DE PROVEEDORES." << endl ;
            ...
            bool exitoC = regC.hacerBackup() ;

            if (exitoC == true) {

                cout << "BACKUP DE CLIENTES REALIZADO CON EXITO." << endl ;



            } else {

                    cout << "ERROR: NO SE PUDO REALIZAR EL BACKUP DE CLIENTES." << endl ;

                    system("pause") ;
                }


            EmpleadoArchivo regEm ;

            bool exitoEm = regEm.hacerBackup() ;

            if (exitoEm == true) {

                cout << "BACKUP DE EMPELADOS REALIZADO CON EXITO." << endl ;

            } else {

                    cout << "ERROR: NO SE PUDO REALIZAR EL BACKUP DE EMPELADOS." << endl ;

                    system("pause") ;
                }


            DetalleVentaArchivo regD ;

            bool exitoD = regD.hacerBackup() ;

            if (exitoD == true) {

                cout << "BACKUP DE LOS DETALLES DE VENTAS REALIZADO CON EXITO." << endl ;

                system("pause") ;

            } else {

                    cout << "ERROR: NO SE PUDO REALIZAR EL BACKUP de DETALLES DE VENTAS." << endl ;
        ...
        case 2: {
                ...
                if(exito == true){
                    ...
                    cout << "ERROR: NO SE PUDO REALIZAR EL BACKUP." << endl ;
        ...
        case 9: {
            ...
            bool exito = reg.restaurarBackup() ;
             ...
             if(exito == true){
                    ...
                    cout << "ERROR: NO SE PUDO RESTAURAR EL ARCHIVO." << endl ;
        ...
        case 16: {
            ...
            bool exito1 = reg1.restaurarBackup() ;

             if(exito1 == true){

                    cout << "ARCHIVO DE VENTAS RESTAURADO CON EXITO." << endl ;
            ...
            ProductoArchivo reg2 ;

            bool exito2 = reg2.restaurarBackup() ;

             if(exito2 == true){

                    cout << "ARCHIVO DE PRODUCTOS RESTAURADO CON EXITO." << endl ;
            ...
            bool exito3 = reg3.restaurarBackup() ;

             if(exito3 == true){

                    cout << "ARCHIVO DE ENVIOS RESTAURADO CON EXITO." << endl ;
           ...
           ProveedorArchivo reg4 ;

            bool exito4 = reg4.restaurarBackup() ;

             if(exito4 == true){

                    cout << "ARCHIVO DE PROVEEDORES RESTAURADO CON EXITO." << endl ;
            ...
            bool exito5 = reg5.restaurarBackup() ;

             if(exito5 == true){

                    cout << "ARCHIVO DE CLIENTES RESTAURADO CON EXITO." << endl ;
            ...
            EmpleadoArchivo reg6 ;

            bool exito6 = reg6.restaurarBackup() ;

             if(exito6 == true){

                    cout << "ARCHIVO DE EMPLEADOS RESTAURADO CON EXITO." << endl ;
            ...
            DetalleVentaArchivo reg7 ;

            bool exito7 = reg1.restaurarBackup() ;

             if(exito7 == true){

                    cout << "ARCHIVO DE DETALLES DE VENTA RESTAURADO CON EXITO." << endl ;
                ...
                cout << endl << "TODOS LOS ARCHIVOS FUERON RESTAURADOS CORRECTAMENTE" << endl ;
