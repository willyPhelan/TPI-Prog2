...
void DetalleVentaArchivo::generarReporteRecaudacionPorTipoProducto() {
    ...
    for (int i = 0; i < total_tipos_distintos; i++) {
        ...
        case 1: nombreTipo = "PCs" ;

        break ;

        case 2: nombreTipo = "Accesorios" ;

        break ;

        case 3: nombreTipo = "Otros" ;

        break ;

        default: nombreTipo = "Desconocido" ;
...
bool DetalleVentaArchivo::hacerBackup(){
    ...
    FILE* pBackup = fopen(archivo_DetalleVentabkp,"wb") ;
...
bool DetalleVentaArchivo::restaurarBackup(){
    ...
    FILE* pArchivoBkp = fopen(archivo_DetalleVentabkp, "rb") ;
