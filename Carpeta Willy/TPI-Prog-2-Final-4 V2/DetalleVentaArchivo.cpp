...
void DetalleVentaArchivo::reportePorMarca(){
    ...
    if (contadoresReporte == nullptr || marcasReporte == nullptr)
    {
    ...
    for (int i = 0; i < cantDetalles; i++){
        ...
        if (indice == -1){
            ...
            if (cantMarcasEncontradas == capacidadActual){
                ...
                if (nuevosContadores == nullptr || nuevasMarcas == nullptr){
            ...
            if(marcasReporte[cantMarcasEncontradas] == nullptr){
    ...
    if (cantMarcasEncontradas == 0){
        ...
        for (int i = 0; i < cantMarcasEncontradas; i++){
            ...
            cout << "Marca: " << marcasReporte[i] << " - Total Unidades: " << contadoresReporte[i] << endl ;
        }
    }
