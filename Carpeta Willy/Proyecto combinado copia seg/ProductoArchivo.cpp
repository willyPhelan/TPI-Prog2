...
bool ProductoArchivo::hacerBackup(){
    ...
    FILE* pBackup = fopen(archivo_Productobkp,"wb") ;
...
bool ProductoArchivo::restaurarBackup(){
    ...
    FILE* pArchivoBkp = fopen(archivo_Productobkp, "rb") ;
...
bool ProductoArchivo::validarDescripcion(const string &descripcion_a_validar){

    // Valido que no exista otro producto con la misma descripcion

    // El tamaño maximo en Producto.h es 200 (char descripcion[200])
    ...
    return true ; // La descripción es valida
}
