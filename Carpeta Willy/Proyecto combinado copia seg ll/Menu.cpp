...
void Menu::subMenuABML_Ventas()
{
                            ...
                            if(nuevaVenta.getMontoTotal() > 50000)
 {
                            ...
                            cout << endl  << "MONTO TOTAL CON ENVIO INCLUIDO $: " << nuevaVenta.getMontoTotal() << endl ; } else {  cout << endl  << "MONTO TOTAL CON ENVIO INCLUIDO $: " << nuevaVenta.getMontoTotal() + nuevoEnvio.getValor_Envio() ; }
...
void Menu::subMenuABML_Listados_Activos()
{
    ...
    do
    {
        ...
        cout << "6. Listado de Productos Activos" << endl ;
