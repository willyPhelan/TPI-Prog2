...
void Menu::subMenuABML_Listados()
{
    ...
    do
    {
        ...
        case 5:
        {
            ...
            if(cantidad == 0)
            {
               cout << "No hay Detalle de Venas cargados en el sistema." << endl ;
            ...
            else
            {
                ...
                cout << "LISTADO DE DETALLE DE VENTA" << endl ;
        ...
        case 5:
        {
          ...
          int cantidad = archivo1.getCantidadRegistros() ;
            ...
            else
            {
                ...
                cout << "LISTADO DE TODOS LOS DETALLE DE VENTA ACTIVOS" << endl ;
